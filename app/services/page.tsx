...
const servicePillars = [
  {
    ...
    tagline: "Systems built for longevity and massive scale.",
    impact: "Turn technical debt into a competitive advantage.",
    description: "Engineering at this level is about more than shipping features—it's about ensuring your system survives the pressure of its own success. We specialize in high-stakes environments where sub-second latency and absolute data integrity are the baseline requirements.",
    image: "https://images.unsplash.com/photo-1551434678-e076c223a692?auto=format&fit=crop&q=80&w=2000", 
    services: [
      { name: "FinTech Development", detail: "Compliant ledger systems and payment orchestration designed for zero-failure tolerance." },
      { name: "Modern Backends", detail: "Event-driven microservices that remain performant under extreme, unpredictable concurrent load." },
      { name: "Systems Integration", detail: "Orchestrating fragmented legacy silos into a unified, high-velocity technical ecosystem." }
    ],
    accentColor: "#2563EB",
    pillarIcon: Zap
  },
  {
    ...
    tagline: "Executive-level strategy with engineering depth.",
    impact: "Align your technical roadmap with commercial reality.",
    description: "Scale fails when there is a disconnect between the boardroom and the codebase. We act as a high-bandwidth partner to founders and executives, providing the technical foresight needed to hire correctly, choose the right stack, and avoid catastrophic pivots.",
    image: "https://images.unsplash.com/photo-1542744173-8e7e53415bb0?auto=format&fit=crop&q=80&w=2000",
    services: [
      { name: "Fractional CTO", detail: "Immediate access to senior leadership for team mentorship, hiring, and long-range roadmap vetting." },
      { name: "E2E Partnership", detail: "Bridging the gap from initial prototype to Series-A readiness with production-grade discipline." },
      { name: "Architecture Strategy", detail: "Identifying hidden technical risks before they become growth-halting bottlenecks." }
    ],
    accentColor: "#0f172a",
    pillarIcon: Activity
  },
  {
    ...
    description: "In modern software, trust is your most fragile asset. We treat infrastructure as a security perimeter—hardening your cloud environment, automating compliance, and ensuring your quality standards meet the expectations of enterprise-level scrutiny.",
    image: "https://images.unsplash.com/photo-1563986768609-322da13575f3?auto=format&fit=crop&q=80&w=2000",
    services: [
      { name: "Cybersecurity Audits", detail: "Deep-packet inspection and threat modeling to defend against sophisticated attack vectors." },
      { name: "Cloud Modernization", detail: "Optimizing cloud spend and security by moving to automated, zero-trust serverless or K8s environments." },
      { name: "Software Quality Audit", detail: "A root-cause analysis of performance degradation, architectural rot, and maintainability gaps." }
    ],
    accentColor: "#1d4ed8",
          ...
          <div className="container px-6 mx-auto grid lg:grid-cols-12 gap-12 items-center">
            <div className="lg:col-span-7 relative z-10">
              ...
              >
                ...
                <span className="text-[10px] font-mono tracking-widest uppercase font-bold text-slate-500">Available for Q3/Q4 2024 Partnerships</span>
              </motion.div>
              ...
              >
                Deep Expertise <br />
                <span className="text-blue-600 italic font-light">Human</span> Partnership.
              </motion.h1>
              ...
              <motion.p 
                ...
                className="max-w-xl text-xl md:text-2xl text-slate-500 leading-relaxed mb-12"
              >
                DeusX provides specialized engineering and technical leadership for teams building high-stakes software. We bridge the gap between complex architecture and commercial reality.
              </motion.p>
              ...
              >
                ...
                <div className="flex items-center gap-4 px-4 border-l border-slate-200">
                  ...
                  <span className="text-[11px] font-mono uppercase tracking-wider text-slate-400">Trusted by Global Teams</span>
                </div>
              </motion.div>
            </div>
        ...
        <section className="py-12 border-b border-slate-100 bg-slate-50/50">
          <div className="container px-6 mx-auto">
            <div className="flex flex-wrap justify-between gap-8 opacity-50 grayscale">
              {['FinTech Foundations', 'Legacy Modernization', 'Architecture Audits', 'Cloud Security'].map((tag) => (
                <span key={tag} className="text-[11px] font-mono uppercase tracking-[0.3em] font-bold">{tag}</span>
              ))}
            </div>
          </div>
        </section>
        ...
        <section className="py-40 bg-white">
          <div className="container px-6 mx-auto">
            <div className="text-center max-w-3xl mx-auto mb-24">
              ...
              <h2 className="text-5xl md:text-6xl font-medium tracking-tight">How we work together.</h2>
            </div>
              ...
              {[
                ...
                <div key={i} className="group p-10 border border-slate-100 hover:border-blue-200 transition-all hover:shadow-2xl hover:shadow-blue-50">
                  <div className="flex items-center gap-4 mb-10">
                    <span className="text-3xl font-mono text-slate-200 group-hover:text-blue-600 transition-colors">{item.step}</span>
          ...
          <div className="container px-6 mx-auto relative z-10">
            <div className="max-w-5xl mx-auto text-center">
              ...
              <div className="flex flex-col md:flex-row items-center justify-center gap-6">
                ...
                <a href="mailto:engineering@deusx.com" className="w-full md:w-auto px-12 py-6 text-lg font-bold border border-white/20 hover:border-white transition-all text-white">
